...
if (isset($_POST['submit'])) {
    ...
    if (!empty($image_name)) {
        ...
        $sql = "SELECT image FROM clothes WHERE id = $id";
    ...
    $sql = "UPDATE clothes SET cloth_name = '$cloth_name', price = '$price', color = '$color', category = '$category', image = '$image_path' WHERE id = $id";
