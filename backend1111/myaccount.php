...
<body>
    ...
    <div class="header">
        ...
        <h1>MY ACCOUNT</h1>
        <img alt="Secure Certificate" height="40" src="secure-logo.png" width="100"/>
    </div>

    <!-- Main Container with Sidebar and Content -->
    <div class="container">
        <!-- Sidebar with User Info and Navigation Links -->
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        <i class="fas fa-gift"></i> Gift cards & vouchers
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="#">
                        <i class="fas fa-comment-dots"></i> Contact preferences
                    </a>
                </li>
                <li>
    ...
    <button type="submit">
        ...
        <!-- Content Section: My Orders -->
        <div class="content">
            <h1>MY ORDERS</h1>
            <div class="orders">
                <i class="fas fa-hanger"></i>
                <p>YOU CURRENTLY HAVE NO ORDERS</p>
                <p>Best get shopping now...</p>
